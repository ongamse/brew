...
module Homebrew
  module Bundle
    module Lister
      sig {
        params(entries: T::Array[T.untyped], formulae: T::Boolean, casks: T::Boolean, taps: T::Boolean,
               mas: T::Boolean, vscode: T::Boolean, cargo: T::Boolean, flatpak: T::Boolean,
               extension_types: T.untyped).void
      }
      ...
      sig {
        params(type: Symbol, formulae: T::Boolean, casks: T::Boolean, taps: T::Boolean, mas: T::Boolean,
               vscode: T::Boolean, cargo: T::Boolean, flatpak: T::Boolean, extension_types: T.untyped)
          .returns(T::Boolean)
      }
